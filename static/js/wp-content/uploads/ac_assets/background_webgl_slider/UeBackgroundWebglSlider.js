...
class UeBackgroundWebglSlider {
    ...
    initBlendSlider() {
        ...
        const uniforms = {
            ...
            uTransition: {
                value: this.options.blendEffect
            },
            uAmplitude: {
                value: 0
            },
            uDistort: {
                value: this.options.distort
            },
            uDistortion: {
                value: this.options.distortionEffect
            },
        }
    ...
    initDisplacementSlider() {
        ...
        const uniforms = {
            ...
            uTransitionDirection: {
                value: this.options.transitionDirection
            },
            uAmplitude: {
                value: 0
            },
    ...
    initNoiseSlider() {
        ...
        const uniforms = {
            ...
            uScale: {
                value: this.options.noiseScale
            },
            uSmoothness: {
                value: this.options.noiseSmoothness
            },
            uAmplitude: {
                value: 0
            },
...
export {
    UeBackgroundWebglSlider as UeBackgroundWebglSlider
}